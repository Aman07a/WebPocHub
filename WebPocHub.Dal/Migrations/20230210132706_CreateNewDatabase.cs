    ...
    public partial class CreateNewDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "East Wing, Z/101", "/images/john-mark.png", "London", "United Kingdom", "john.mark@email.com", "John Mark", "+044 73783783", "DBA", "473837" },
                    { 2, "Nort Wing, Moon-01", "/images/alisha-c.png", "Mumbai", "India", "alisha.c@email.com", "Alisha C.", "+91 7865678645", "People Management", "367534" },
                    { 3, "Suncity, A8/404", "/images/dabade-pravinkumar.png", "Pune", "India", "dabade.pravinkumar@email.com", "Pravinkumar Dabade", "+044 73783783", "Trainer & Consultant", "411051" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Employee of our Organization!", "Employee" },
                    { 2, "Hr of our Organization!", "Hr" }
                });
